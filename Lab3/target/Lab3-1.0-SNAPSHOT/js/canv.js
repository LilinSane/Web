...
function draw_triangle(r){
	...
	ctx.fillStyle = "rgba(245, 17, 237, 0.5)";
	ctx.beginPath();
	ctx.moveTo(MAX_WIDTH/2, MAX_HEIGHT - 135 + MAX_DIVISION*DIVISION_SIZE - r*DIVISION_SIZE);
	ctx.lineTo(MAX_WIDTH/2, MAX_HEIGHT/2);
	ctx.lineTo(MAX_WIDTH/2 + r*DIVISION_SIZE/2, MAX_HEIGHT/2);
	ctx.lineTo(MAX_WIDTH/2, MAX_HEIGHT - 135 + MAX_DIVISION*DIVISION_SIZE - r*DIVISION_SIZE);
	ctx.fill();
}
...
function draw_circle(r){
	...
	ctx.fillStyle = "rgba(245, 17, 237, 0.5)";
	ctx.beginPath();
	ctx.arc(MAX_WIDTH/2, MAX_HEIGHT/2, r*DIVISION_SIZE, 0, +Math.PI/2, false);
	ctx.fill();
